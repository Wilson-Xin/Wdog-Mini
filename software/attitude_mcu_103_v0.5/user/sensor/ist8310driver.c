...
void ist8310_mag_cal(uint8_t mag[6]);
float mag_offset[3]={235.1f,58.6f,-84.6};//零点偏移
float ABC[3]={111.2f,117.9f,165.2f};//椭球系数
...
void ist8310_read_mag(fp32 mag[3])
{
    ...
    mag[1] = MAG_SEN * (temp_ist8310_data-mag_offset[0])*-1.0f;
    temp_ist8310_data = (int16_t)((buf[3] << 8) | buf[2]);
    mag[0] = MAG_SEN * (temp_ist8310_data-mag_offset[1])*-0.94f;
    temp_ist8310_data = (int16_t)((buf[5] << 8) | buf[4]);
    mag[2] = MAG_SEN * (temp_ist8310_data-mag_offset[2])*0.67f;
}
