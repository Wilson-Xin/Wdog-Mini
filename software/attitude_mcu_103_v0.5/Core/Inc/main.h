...
#define INT1_ACCEL_EXTI_IRQn EXTI1_IRQn
#define CS1_ACCEL_Pin GPIO_PIN_2
#define CS1_ACCEL_GPIO_Port GPIOA
#define INT1_GYRO_Pin GPIO_PIN_3
#define INT1_GYRO_GPIO_Port GPIOA
#define INT1_GYRO_EXTI_IRQn EXTI3_IRQn
#define CS1_GYRO_Pin GPIO_PIN_4
#define CS1_GYRO_GPIO_Port GPIOA
#define IST8310_DRDY_Pin GPIO_PIN_12
#define IST8310_DRDY_GPIO_Port GPIOB
#define IST8310_DRDY_EXTI_IRQn EXTI15_10_IRQn
#define IST8310_RST_Pin GPIO_PIN_13
